...
public class SmallSearchBox<E extends UniqueName> extends JPanel {
    ...
    public SmallSearchBox(String name, ArrayList<E> master, Instance curInst) {
        super();
            ...
            //Group Layout
            {
                ...
                main.setVerticalGroup(
                        main.createSequentialGroup().addComponent(
                                ...
                                pane, 21, 60, GroupLayout.PREFERRED_SIZE
                        )
                );
            }
        }
    ...
    public boolean setSelectedItem(E item) {
        for (int i = 0; i < LIST.getModel().getSize(); i++) {
            if (LIST.getModel().getElementAt(i).equals(item)) {
                LIST.setSelectedIndex(i);
                SEARCH.setText(item.toString());
                return true;
            }
        }
        return false;
