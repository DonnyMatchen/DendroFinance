...
public class MarketApiEditGui extends BackingEditGui<LMarketApi> {
    ...
    private JTextArea url_, urlH_, urlM_, urlMH_, key_, path_, pathH_, pathM_, pathMH_, nats_, excepts_;
    ...
    protected void initComponents() {
        ...
        JLabel m = new JLabel("Exceptions");
        JLabel n = new JLabel("Separator");
        JLabel o = new JLabel("Multisearch Bound");
        JLabel p = new JLabel("Multisearch History Bound");
        JLabel q = new JLabel("API Call Attempt Limit");
        JLabel r = new JLabel("API Wait Duration");
