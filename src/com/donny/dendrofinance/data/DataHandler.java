...
public class DataHandler {
    ...
    public boolean purchaseSale(LDate date, BigDecimal amount, BigDecimal cost, Exchange exchange, LCurrency currency) {
        try {
            ...
            if (amount.compareTo(BigDecimal.ZERO) > 0) {
                ...
                String gl = getGainLoss(currency, profitSR, profitLR);
                capsule.insert(
                        date,
                        exchange.NAME,
                        currency.toString(),
    ...
    private String getGainLoss(LCurrency currency, BigDecimal profitSR, BigDecimal profitLR) {
        String gl = "";
    ...
    public boolean trade(LDate date, BigDecimal fromAmount, BigDecimal toAmount, BigDecimal unit,
        ...
        try {
            ...
            String gl = getGainLoss(fromCur, profitSR, profitLR);
            capsule.insert(
                    date,
                    exchange.NAME,
                    fromCur + ", " + toCur,
